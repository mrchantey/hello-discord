...
//!
//! These builders wrap twilight-model types and provide a pleasant API for
//! constructing `Command`, `Embed`, and message components without filling
//! in 15-field structs with `None` everywhere.
//!
...
///
/// ```ignore
/// use crate::discord_helpers::builders::ApplicationCommandBuilder;
///
...
///
/// ```ignore
/// use crate::discord_helpers::builders::EmbedBuilder;
///
