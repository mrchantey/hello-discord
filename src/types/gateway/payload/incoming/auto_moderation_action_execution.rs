...
///
/// [`Permissions::MANAGE_GUILD`]: crate::types::guild::Permissions::MANAGE_GUILD
...
pub struct AutoModerationActionExecution {
    ...
    /// [`SendAlertMessage`].
    ///
    /// [`SendAlertMessage`]: crate::types::guild::auto_moderation::AutoModerationActionType::SendAlertMessage
    ...
    ///
    /// [`Intents::MESSAGE_CONTENT`]: crate::types::gateway::Intents::MESSAGE_CONTENT
    pub content: String,
