use crate::types::channel::message::MessagePin;
...
mod tests {
    ...
    use crate::types::channel::message::sticker::StickerFormatType;
    use crate::types::channel::message::{
        MessageCall, MessageFlags, MessagePin, MessageSticker, MessageType, PinsListing,
    };
    use crate::types::guild::{MemberFlags, PartialMember};
    use crate::types::id::Id;
    use crate::types::test::image_hash;
