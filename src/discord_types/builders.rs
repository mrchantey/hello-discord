...
use crate::discord_types::application::command::{
    Command, CommandOption, CommandOptionChoice, CommandOptionType, CommandType,
};
use crate::discord_types::id::{marker::CommandMarker, Id};
...
impl EmbedBuilder {
    ...
    pub fn timestamp(mut self, ts: impl Into<String>) -> Self {
        ...
        if let Ok(parsed) = crate::discord_types::util::Timestamp::parse(&ts.into()) {
