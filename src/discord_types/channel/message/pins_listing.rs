use crate::discord_types::channel::message::MessagePin;
use serde::{Deserialize, Serialize};

/// Pins listing request object for `get_pins` endpoint. [docs]
///
/// [docs]: https://discord.com/developers/docs/resources/message#get-channel-pins-response-structure
#[derive(Clone, Debug, Deserialize, PartialEq, Serialize)]
pub struct PinsListing {
    /// The fetched message pins based on the query.
    pub items: Vec<MessagePin>,
    /// If there is more pins that exists outside the returned items in the channel.
    pub has_more: bool,
}

#[cfg(test)]
mod tests {
    use crate::discord_types::channel::Message;
    use crate::discord_types::channel::message::sticker::StickerFormatType;
    use crate::discord_types::channel::message::{
        MessageCall, MessageFlags, MessagePin, MessageSticker, MessageType, PinsListing,
    };
    use crate::discord_types::guild::{MemberFlags, PartialMember};
    use crate::discord_types::id::Id;
    use crate::discord_types::test::image_hash;
    use crate::discord_types::user::User;
    use crate::discord_types::util::Timestamp;
    ...
    fn pins_listing() {
        ...
        let msg_pin = MessagePin {
            pinned_at: Timestamp::from_secs(1).unwrap(),
            message: msg_value,
        };

        let value = PinsListing {
            items: vec![msg_pin],
            has_more: true,
        };
