use crate::discord_types::guild::audit_log::AuditLogEntry;
...
/// the event.
///
/// [`GuildAuditLogEntryCreate`]: crate::types::gateway::event::Event::GuildAuditLogEntryCreate
/// [`Event`]:crate::types::gateway::event::Event
/// [`VIEW_AUDIT_LOG`]: crate::types::guild::Permissions::VIEW_AUDIT_LOG
