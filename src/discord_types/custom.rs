...
pub struct ReadyEvent {
    ...
    #[serde(default)]
    pub guilds: Vec<crate::discord_types::guild::UnavailableGuild>,
...
pub struct ReadyApplication {
    pub id: Id<crate::discord_types::id::marker::ApplicationMarker>,
...
pub struct PresenceUpdate {
    ...
    #[serde(default)]
    pub activities: Vec<crate::discord_types::gateway::presence::Activity>,
}
...
pub struct CreateMessage {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub embeds: Option<Vec<crate::discord_types::channel::message::embed::Embed>>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub message_reference: Option<CreateMessageReference>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub components: Option<Vec<crate::discord_types::channel::message::component::Component>>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl CreateMessage {
    ...
    #[allow(dead_code)]
    pub fn embed(mut self, embed: crate::discord_types::channel::message::embed::Embed) -> Self {
    ...
    pub fn component_row(
        mut self,
        row: crate::discord_types::channel::message::component::Component,
    ) -> Self {
