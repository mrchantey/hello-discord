...
//!
//!
//! [`ModalSubmit`]: crate::types::application::interaction::InteractionType::ModalSubmit
mod action_row;
mod file_upload;
mod label;
mod select_menu;
...
use crate::discord_types::application::interaction::modal::select_menu::ModalInteractionSelectMenu;
use crate::discord_types::application::interaction::InteractionDataResolved;
use crate::discord_types::channel::message::component::ComponentType;
use crate::discord_types::id::marker::{ChannelMarker, GenericMarker, RoleMarker, UserMarker};
...
// Fork: replaced serde_value with serde_json::Value
...
impl<'de> Visitor<'de> for ModalInteractionDataComponentVisitor {
    ...
    fn visit_map<V: MapAccess<'de>>(self, mut map: V) -> Result<Self::Value, V::Error> {
        fn deserialize_select_menu<ValueType: serde::de::DeserializeOwned, Error: DeError>(
            id: i32,
...
mod tests {
    use super::*;
    use crate::discord_types::application::interaction::InteractionChannel;
    use crate::discord_types::channel::ChannelType;
    use crate::discord_types::guild::Permissions;
    ...
    #[test]
    #[ignore = "serde_test tokens incompatible with serde_json::Value replacement (fork)"]
    #[allow(clippy::too_many_lines)]
    fn modal_labels() {
        let value = ModalInteractionData {
            custom_id: "test-modal".to_owned(),
