...
use crate::discord_types::id::marker::AttachmentMarker;

/// User filled in [`FileUpload`].
///
/// See [Discord Docs/File Upload Interaction Response Structure]
///
/// [`FileUpload`]: crate::types::channel::message::component::FileUpload
...
pub struct ModalInteractionFileUpload {
    ...
    ///
    /// [`ModalInteractionData::resolved`]: crate::types::application::interaction::modal::ModalInteractionData::resolved
