use crate::discord_types::user::AvatarDecorationData;
...
///
/// [`ApplicationCommand`]: crate::types::application::interaction::InteractionType::ApplicationCommand
...
mod tests {
    ...
    use crate::discord_types::guild::RoleColors;
    use crate::discord_types::user::PrimaryGuild;
    use crate::discord_types::{
        channel::{
